...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(29, 29, 411, 371))
        ...
        self.shortcut_command = QtWidgets.QComboBox(self.gridLayoutWidget)
        ...
        self.actionType = QtWidgets.QLabel(self.gridLayoutWidget)
